package com.xwbing.web.controller.pay;
...
import com.xwbing.service.pay.dto.PayOrderReqDTO;
import com.xwbing.service.pay.dto.TradeReqDTO;
import com.xwbing.service.pay.dto.TradeRespDTO;
import com.xwbing.service.pay.strategy.PayStrategyFactory;
...
public class PayController {
    ...
    public ApiResponse<TradeRespDTO<Object>> createPayOrder(@RequestBody @Validated PayOrderReqDTO dto) {
        TradeReqDTO payReqDTO = TradeReqDTO.of(dto.getPayWay(), dto.getOrderNo(), "支付测试", 1L, "281430623401443343");
        TradeRespDTO<Object> pay = payFactory.getStrategy(dto.getPayType()).createTrade(payReqDTO);
