...
public class SensitiveInfoUtil {
     ...
     * @return
     */
    public static String showName(String realName, String sex) {
        //获取姓氏
        int endIndex = realName.length() > 3 ? 2 : 1;
        String lastName = realName.substring(0, endIndex);

        //获取称呼
        String appellation = "1".equals(sex) ? "先生" : ("2".equals(sex) ? "女士" : "");

        return lastName + appellation;
    }
}
